import cat.Cat;
import cat.CountingCat;
import digit.DigitFinder;
import example.StreamExample;
import fraction.CachedFraction;
import fraction.Fraction;
import list.ListProcessor;
import peoplestream.PeopleStream;
import point.Point;
import point.Polyline;
import queue.QueueChecker;
import smetana.SmetanaMonitor;
    ...
    public static void main(String[] args) {
        ...
        while(choice != 0) {
            if (choice == -1) {
                ...
                System.out.println("3 - Структурный паттерн - Decorator на примере класса cat.Cat.");
                ...
                System.out.println("8 - РStream (point.Polyline из точек)");
            ...
            switch (choice) {
                ...
                case 8:
                    System.out.println("Задание 8: Stream (point.Polyline из точек)");
