    ...
    public static void main(String[] args) {
        ...
        while(choice != 0) {
            if (choice == -1) {
                ...
                System.out.println("1 - Проверка аннотации Invoke");
                System.out.println("2 - Проверка аннотации Default");
                System.out.println("3 - Проверка аннотации ToString");
                System.out.println("4 - Проверка аннотации Validate");
                System.out.println("5 - Проверка аннотации Two");
            ...
            switch (choice) {
                case 1:
                    System.out.println("Проверка @Invoke");
                    try {
                        TestOne testObj = new TestOne();
                        InvokeHandler handler = new InvokeHandler();
                        System.out.println("Автоматический вызов методов с @Invoke: ");
                ...
                case 2:
                    System.out.println("Проверка @Default");
