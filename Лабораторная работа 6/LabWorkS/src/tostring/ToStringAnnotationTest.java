...
/**
 * Класс tostring.ToStringAnnotationTest содержит тесты для проверки работы аннотации @tostring.ToString
 * и класса tostring.ToStringHandler.
 */
public class ToStringAnnotationTest {

    /**
     * Проверяет наличие аннотации @tostring.ToString на классе tostring.TestThree.
     */
    @Test
    void testClassAnnotation() {
        ToString annotation = TestThree.class.getAnnotation(ToString.class);
        assertNotNull(annotation, "Аннотация @tostring.ToString должна быть на классе tostring.TestThree");
        assertEquals(Mode.YES, annotation.value(), "По умолчанию значение должно быть YES");
    }

    /**
     * Проверяет значения аннотаций @tostring.ToString на полях класса tostring.TestThree.
     */
    @Test
    ...
    /**
     * Проверяет работу метода generateToString у tostring.ToStringHandler.
     */
    @Test
